...
class Handler(BaseHTTPRequestHandler):
    ...
    def _send(self, code: int, body, ctype: str = "application/json") -> None:
        ...
        try:
            ...
            # Client hung up before we finished writing (e.g. the UI reloaded or
            # navigated away while a slow endpoint like update_check was mid-git-
            # fetch). A normal disconnect, not a server error — every response
            # goes through here, so swallowing it keeps the log clean.
            return
